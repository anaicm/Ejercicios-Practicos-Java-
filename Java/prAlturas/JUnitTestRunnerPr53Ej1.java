...
import prAlturas.Mundo;
import prAlturas.Pais;
...
public class JUnitTestRunnerPr53Ej1 {
	//----------------------------------------------------------------------
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	...
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
/*	public static class JUnitTestCompAltura {
		private CompAltura cmp1;
		@BeforeClass
		public static void beforeClass() {
			// Code executed before the first test method
			System.out.println("Start of CompAltura JUnit Test");
		}
		@AfterClass
		public static void  afterClass() {
			// Code executed after the last test method
			System.out.println("End of CompAltura JUnit Test");
		}
		@Before
		public void setUp() throws Exception {
			// Code executed before each test
		...
		@Test(timeout = 1000)
		public void compAlturaCtorTest2() throws Exception {
			assertTrue("\n> Error: CompAltura implements Comparator<?>:", ((Object)cmp1 instanceof java.util.Comparator<?>));
		}
		@Test(timeout = 1000)
		public void compAlturaCompareTest1() throws Exception {
			Pais p1 = new Pais("Turkey", "Euro/Asia", 1.74);
			//----------------------
			precond("Turkey", p1.getNombre());
			precond("Euro/Asia", p1.getContinente());
			precond(1.74, p1.getAltura(), 0.00001);
			//----------------------
			Pais p2 = new Pais("Turkey", "Asia", 1.74);
			assertEquals("\n> Error: cmp1.compare(p1,p2): ", 0, cmp1.compare(p1,p2));
			//----------------------
			Pais p3 = new Pais("Iceland", "Europe", 1.74);
			assertTrue("\n> Error: cmp1.compare(p1,p3): ", cmp1.compare(p1,p3) > 0);
			assertTrue("\n> Error: cmp1.compare(p3,p1): ", cmp1.compare(p3,p1) < 0);
			//------------------------
			Pais p4 = new Pais("Iceland", "Europe", 1.81);
			assertTrue("\n> Error: cmp1.compareTo(p1,p4): ", cmp1.compare(p1,p4) < 0);
			assertTrue("\n> Error: cmp1.compareTo(p4,p1): ", cmp1.compare(p4,p1) > 0);
		}
		//------------------------------------------------------------------
	}
*/	//----------------------------------------------------------------------
